window.onload = function () {
	...
	// Get elements
	var showLives = document.getElementById("mylives").innerHTML = "You have ";
	...
	comments = function () {
		if (lives <= 10) {
			document.getElementById("mylives").innerHTML = showLives + lives + " lives left.";
		}
	...
	// Play
	play = function () {
		var clue = (document.getElementById("clue").innerHTML = "Clue: -");
	...
	hint.onclick = function () {
		...
		if (hints == hints) {
			document.getElementById("hint").style.backgroundColor = "lightGray";
		}
